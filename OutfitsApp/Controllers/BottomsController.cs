...
namespace OutfitsApp.Controllers
{
    public class BottomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomID,BottomBrand,BottomStyle,BottomSeason,BottomOccasion,BottomPhoto")] Bottom bottom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomID,BottomBrand,BottomStyle,BottomSeason,BottomOccasion,BottomPhoto")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
